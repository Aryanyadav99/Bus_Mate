...
class SeatPlanViewWidget extends StatelessWidget {
  final int totalSeat;
  ...
  const SeatPlanViewWidget(
      {super.key, required this.totalSeat, required this.bookedSeatNumbers, required this.totalSeatBooked, required this.isBusinessClass, required this.onSeatSelected});
                ...
                Row(
                  ...
                  children: [
                    for(int j = 0; j < seatArrangement[i].length; j++)
                      Row(
                        children: [
                          Seat(label: seatArrangement[i][j],
